...
const GameCardComponent = (props: GameCardComponentProps): JSX.Element => {
    ...
    const { value, onClick, currentState } = props    //Destructure props

    //Component className
    const className = classNames(styles.gameCard, { [styles.gameCardDisplay]: !onClick, [styles.correct]: currentState === 'correct', [styles.incorrect]: currentState === 'incorrect' })
